...
import com.dzj.mapper.ExamRecordMapper;
import com.dzj.mapper.UserMapper;
import com.dzj.service.ExamRecordService;
import com.dzj.utils.CertificateUtil.ContentStyle;
import com.dzj.utils.CertificateUtil.DateTimeUtil;
import com.dzj.utils.CertificateUtil.PDFUtil;
import com.dzj.utils.JwtUtils;
import com.dzj.utils.RedisUtil;
...
import static com.dzj.utils.CommonUtils.setEqualsQueryWrapper;
...
//         String backgroundImage = "/dzj/nginx_static_resources/certificateBg.png";
//         String logo = "/dzj/nginx_static_resources/logo.png";
//         String pdfFilePath = "/dzj/nginx_static_resources/templateCertificate.pdf";
        ...
        //  创建证书
        try {
            pdfUtil.openDocument(pdfFilePath).addImage(backgroundImage, 0, 400).addLogo(logo, 270, 480).addContent(userInfo, 85, 630, style1).addContent("特发此证,以资鼓励!", 125, 495, style2).addContent("Power By YSchool", 360, 495, style2);
            //  结束截取字符串的索引
            int end;
            //  证书内容分行,防止超出证书边缘

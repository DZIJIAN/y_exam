...
public class User implements Serializable {
    ...
    @ApiModelProperty(value = "登录用户名", example = "dzj")
    private String username;

    @ApiModelProperty(value = "真实姓名", example = "dzj")
    ...
    @ApiModelProperty(value = "用户创建时间", example = "2021-10-22 10:35:44")
